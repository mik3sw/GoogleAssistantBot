    ...
    if query.data == 'nuke':
        try:
            ...
            context.bot.send_video(update.callback_query.message.chat_id,
                ...
                caption='<b>NUCLEARIZZAZIONE COMPLETATA</b>\n<b>Stato obiettivo</b>: eliminato\n<b>Resoconto</b>: il lancio ha avuto successo', parse_mode='HTML')
            global nuked
            #print(nuked)
            context.bot.ban_chat_member(update.callback_query.message.chat_id, nuked, timeout=None, until_date=None)
            #print(stronzo)
