...
def main():
    ...
    dp.add_handler(CommandHandler(["io", "me"], commands.io.init))
    dp.add_handler(CommandHandler(["muta", "mute"], commands.muta.init))
    dp.add_handler(CommandHandler(["smuta", "unmute"], commands.smuta.init))
    dp.add_handler(CommandHandler(["fissa", "pin"], commands.fissa.init))
